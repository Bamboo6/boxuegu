...
public class UserInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showTypeDialog() {
        ...
        View view = View.inflate(this, R.layout.activity_edit_icon, null);
        tv_select_gallery = (Button) view.findViewById(R.id.choose_from_album);
        tv_select_camera = (Button) view.findViewById(R.id.take_photo);
